...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_query = "SELECT nome FROM Loja WHERE nome = '$nome'";
    $check_result = mysqli_query($link, $check_query);

    if (mysqli_num_rows($check_result) > 0) {
        $_SESSION['msg'] = "O nome da loja já está cadastrado.";
        header("location: inserir_lojas.php");
        exit();
    }

    $query = "INSERT INTO Loja (nome, cidade_id) VALUES ('$nome', '$cidade_id')";
            ...
            <div class="col-md-7 col-lg-5">
                <div class="wrap">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        <div class="d-flex">
                            <div class="w-100">
                                <h3 class="mb-4">Cadastro de Loja</h3>
                            </div>
                        </div>
                        <div class="content">
                            ...
                            <form class="form" method="POST" action="">
                                ...
                                <br><br>
                                <br><input type="submit" class="form-control btn btn-primary rounded submit px-3" value="Salvar loja">
                            </form>
                        </div><br>
