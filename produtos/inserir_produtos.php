...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO Produto (nome, preco, fornecedor_id) VALUES ('$nome', '$preco', '$fornecedor_id')";
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <div class="content">
                            ...
                            <form class="form" method="POST" action="">
                                ...
                                <br><br>
                                <br><input type="submit" class="form-control btn btn-primary rounded submit px-3" value="Salvar Produto">
                            </form>
                        </div><br>
