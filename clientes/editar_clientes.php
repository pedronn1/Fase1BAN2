...
$query = "SELECT * FROM Cliente WHERE cliente_id = '$codigo'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_query = "SELECT cliente_id FROM Cliente WHERE nome = '$nome' AND cliente_id != '$codigo'";
    $check_result = mysqli_query($link, $check_query);

    if (mysqli_num_rows($check_result) > 0) {
        $_SESSION['msg'] = "O nome do cliente já está em uso.";
        header("location: editar_clientes.php?codigo=$codigo"); 
        exit();
    }

    $updateQuery = "UPDATE Cliente SET nome = '$nome', cidade_id = '$cidade_id' WHERE cliente_id = '$codigo'";
            ...
            <div class="col-md-7 col-lg-5">
                <div class="wrap">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <p class="text-center"> <a href="ver_clientes.php">Voltar</a></p>
                    </div>
                </div>
            </div>
        </div>
