...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_query = "SELECT nome FROM Funcionario WHERE nome = '$nome'";
    $check_result = mysqli_query($link, $check_query);

    if (mysqli_num_rows($check_result) > 0) {
        $_SESSION['msg'] = "O nome do funcionario já está cadastrado.";
        header("location: inserir_funcionarios.php");
        exit();
    }

    $query = "INSERT INTO Funcionario (nome, cidade_id) VALUES ('$nome', '$cidade_id')";
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <div class="content">
                            ...
                            <form class="form" method="POST" action="">
                                ...
                                <br><br>
                                <br><input type="submit" class="form-control btn btn-primary rounded submit px-3" value="Salvar Funcionario">
                            </form>
                        </div><br>
