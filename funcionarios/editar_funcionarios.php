...
if (!isset($_GET['codigo'])) {
    echo "Código do funcionario não fornecido";
    exit();
}

$codigo = $_GET['codigo'];

$query = "SELECT * FROM Funcionario WHERE funcionario_id = '$codigo'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_query = "SELECT funcionario_id FROM Funcionario WHERE nome = '$nome' AND funcionario_id != '$codigo'";
    $check_result = mysqli_query($link, $check_query);

    if (mysqli_num_rows($check_result) > 0) {
        $_SESSION['msg'] = "O nome do funcionario já está em uso.";
        header("location: editar_funcionarios.php?codigo=$codigo");
        exit();
    }

    $updateQuery = "UPDATE Funcionario SET nome = '$nome', cidade_id = '$cidade_id' WHERE funcionario_id = '$codigo'";
            ...
            <div class="col-md-7 col-lg-5">
                <div class="wrap">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <p class="text-center"> <a href="ver_funcionarios.php">Voltar</a></p>
                    </div>
                </div>
            </div>
        </div>
